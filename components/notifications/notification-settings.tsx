...
import { useGetAllPreferencesQuery, useUpdatePreferencesMutation } from "@/redux/features/notifications/notificationsApiSlice"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { Switch } from "@/components/ui/switch"
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"
import { Button } from "@/components/ui/button"
import { Loader2, Bell, Mail, Phone, BellRing } from 'lucide-react'
...
export function NotificationSettings() {
  ...
  const categories = Object.keys(preferences).sort()
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure how you receive {category.toLowerCase()} notifications
        </CardDescription>
      </CardHeader>
      <CardContent>
