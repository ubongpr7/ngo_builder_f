...
// Total number of steps for verified users
const TOTAL_STEPS = 6

export function VerifiedUserKYCForm({ profileId, userId }: KYCFormContainerProps) {
  ...
  useEffect(() => {
    if (userProfile) {
      ...
      // Update roles (for reference only, not editable)
      ...
      // Update identity verification (for reference only, not editable)
